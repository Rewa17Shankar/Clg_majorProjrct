...
// import { fetchEmployees } from "../api/employeeApi"; // you already have this
...
//   // Request Form (useful for HR to file on behalf of employee or for testing)
...
//       {/* SECTION: Leave Types */}
//       <section>
//         <h2 className="text-2xl font-semibold mb-4">Leave Types</h2>

//         {/* Add / Edit Type */}
//         <div className="grid md:grid-cols-2 gap-6">
//           <form onSubmit={editingType ? handleUpdateType : handleAddType} className="border rounded p-4 space-y-3">
...
//               onChange={(e) =>
//                 editingType
//                   ? setEditingType((prev) => ({ ...prev, type: e.target.value }))
...
//                 </li>
//               ))}
//               {!types.length && <li className="py-2 text-sm text-gray-500">No leave types yet.</li>}
//             </ul>
//           </div>
//         </div>
//       </section>
...
//         <form onSubmit={handleCreateRequest} className="grid md:grid-cols-5 gap-3 border rounded p-4 mb-6">
//           <select
//             className="border rounded p-2"
//             value={form.user_id}
...
//                   <td className="p-2">{new Date(r.applied_at).toLocaleString()}</td>
